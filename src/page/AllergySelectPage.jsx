...
import { useGlobalData } from "../context/DataContext"; // 경로를 필요에 맞게 조정하세요
...
const AllergySelectPage = () => {
  ...
  const isSelected = (allergy) => (allergyData ? allergyData[allergy] : false);

  return (
    <div className='container'>
      <div className='sub-container'>
        <div className='header-text'>알레르기가 있으신가요?</div>
        <IdCheck inputValue={inputValue} setInputValue={setInputValue} />
        <AllergyButtons
          selectedAllergies={Object.keys(allergyData || {}).filter(
